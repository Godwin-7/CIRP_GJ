  ...
  return (
    <section id="about">
      ...
      <div className="about-wrapper">
        <img src="images/network.svg" alt="Project Showcase Image" />
      ...
      <div className="about-wrapper">
        <img src="images/teamwork.svg" alt="Expert Mentorship Image" />
      ...
      <div className="about-wrapper">
        <img src="images/analysis.svg" alt="Idea Validation Image" />
            ...
            <div className="swiper-slide">
              <div className="about-card">
                ...
                <div className="about-card-text">
                  <p>
                    Our platform allows innovators, researchers, and creators to showcase their projects or ideas in various fields. 
                    Each project includes a detailed description, goals, and potential applications. Interested collaborators can directly connect with authors.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="swiper-slide">
              <div className="about-card" style={{ borderColor: "#FFC906" }}>
                ...
                <div className="about-card-text">
                  <p>
                    Gain access to a diverse pool of experts from different industries who are ready to guide and mentor you through your project journey. 
                    Our platform bridges the gap between idea creators and subject matter experts.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="swiper-slide">
              <div className="about-card" style={{ borderColor: "#2B77B5" }}>
                ...
                <div className="about-card-text">
                  <p>
                    Validate your ideas with real-time feedback from industry professionals and collaborators. 
                    Our platform helps assess the feasibility, scalability, and market potential of your research or project.
                  </p>
                </div>
              </div>
            </div>
